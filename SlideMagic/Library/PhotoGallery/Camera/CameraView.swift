...
class CameraView: UIView, UIGestureRecognizerDelegate {
  ...
  func makeFlashButton() -> TripleButton {
    let states: [TripleButton.ButtonState] = [
      TripleButton.ButtonState(title: NSLocalizedString("OFF", comment: "OFF"), image: GalleryBundle.image("gallery_camera_flash_off")!),
      TripleButton.ButtonState(title: NSLocalizedString("ON", comment: "ON"), image: GalleryBundle.image("gallery_camera_flash_on")!),
      TripleButton.ButtonState(title: NSLocalizedString("AUTO", comment: "AUTO"), image: GalleryBundle.image("gallery_camera_flash_auto")!)
    ]
  ...
  func makeDoneButton() -> UIButton {
    ...
    button.setTitle(NSLocalizedString("Done", comment: "Done"), for: UIControl.State())
