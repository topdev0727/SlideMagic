...
public class GalleryController: UIViewController, PermissionControllerDelegate {
  ...
  func makeImagesController() -> ImagesController {
    ...
    controller.title = NSLocalizedString("PHOTOS", comment: "PHOTOS")
  ...
  func makeCameraController() -> CameraController {
    ...
    controller.title = NSLocalizedString("CAMERA", comment: "CAMERA")
  ...
  func makeVideosController() -> VideosController {
    ...
    controller.title = NSLocalizedString("VIDEOS", comment: "VIDEOS")
