...
class PermissionView: UIView {
  ...
  func makeLabel() -> UILabel {
    ...
    if Permission.Camera.needsPermission {
      label.text = NSLocalizedString("Please grant access to photos and the camera.", comment: "Please grant access to photos and the camera.")
    } else {
      label.text = NSLocalizedString("Please grant access to photos.", comment: "Please grant access to photos.")
    }
  ...
  func makeSettingButton() -> UIButton {
    ...
    button.setTitle(NSLocalizedString("Go to Settings", comment: "Go to Settings").uppercased(),
                    for: UIControl.State())
