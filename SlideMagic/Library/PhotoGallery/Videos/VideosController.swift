...
class VideosController: UIViewController {
  ...
  func setup() {
    ...
    gridView.arrowButton.updateText(NSLocalizedString("ALL VIDEOS", comment: "ALL VIDEOS"))
  ...
  func makeInfoLabel() -> UILabel {
    ...
    label.text = String(format: NSLocalizedString("FIRST %d SECONDS", comment: "FIRST %d SECONDS"),
